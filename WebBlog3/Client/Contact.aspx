        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="portfolio.aspx">Portfolio</a>
                    </li>
                     <li>
                        <a class="page-scroll" href="About.aspx">About</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#page-top">Contact</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button class="btn btn-danger" onclick="send()"> send Email</button>
                            </div>
                        </div>
                    </form>
                </div>
